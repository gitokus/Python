...
# for row in range(1):
    ...
    print(len(data1.sType))
    print(len(data2.sType))
    ...
    for i in range(8):
        ...
        print(sValue2)
        p1.plot(imageIndex1, sValue1, color='b', marker='.', lw=0, markersize=2, linestyle='none')
        p1.plot(imageIndex2, sValue2, color='r', marker='.', lw=0, markersize=2, linestyle='none')
        plt.legend(['rM8640955', 'rM8841557'], loc='upper left')
        ...
        p2.plot(imageIndex1, sConf1, color='b', lw=1.5, marker='.', markersize=2, linestyle='none')
        p2.plot(imageIndex2, sConf2, color='r', lw=1.5, marker='.', markersize=2, linestyle='none')
        ...
        p3.plot(imageIndex1, sSupType1, color='b', lw=1.5, marker='.', markersize=2, linestyle='none')
        p3.plot(imageIndex2, sSupType2, color='r', lw=1.5, marker='.', markersize=2, linestyle='none')
        ...
        p4.plot(imageIndex1, sRelDec1, color='b', lw=1.5, marker='.', markersize=2, linestyle='none')
        p4.plot(imageIndex2, sRelDec2, color='r', lw=1.5, marker='.', markersize=2, linestyle='none')
